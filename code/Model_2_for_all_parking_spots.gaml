...
* This version is for modeling all parking spots as first parking spot.
...
//     Start at a parking spot given by the current simulation_counter
...
// it is important to adapt the max to your number of adresses the right number ist number of adresses -1
