...
species deliverer skills:[moving] {
	...
	aspect base{
		...
		draw file("path/to/your/svg.svg") at: {location.x, location.y, 10} size: 10 color: color rotate:180;
		//use the following line without "//" to show the next targets entry point
		//draw circle(10) at:the_target_entrance color: #orange; 
...
//     Start at the parking spot nearest to the starting point
...
experiment Flyer_delivery type: gui {
	...
	parameter "Shapefile for the roads for the deliverer:" var: street_for_deliverer category: "GIS" ;
	parameter "Shapefile for the street:" var: street_shapefile category: "GIS" ;
	parameter "Shapefile for the starting point:" var: start_point category: "GIS" ;
